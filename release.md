...
- The `appcast.xml` is deployed to GitHub Pages at
  `https://amio.github.io/KeyMagic/appcast.xml`.

---

## Auto-Update Architecture

KeyMagic uses [Sparkle 2](https://sparkle-project.org/) for automatic updates.

### How it works

1. The app checks `https://amio.github.io/KeyMagic/appcast.xml` for new versions
...
| `Sources/KeyMagicKit/Services/UpdateService.swift` | Wraps Sparkle's `SPUUpdater` |
