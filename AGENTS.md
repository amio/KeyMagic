...
- **Build System**: Xcode 26 metadata is generated by XcodeGen from `project.yml`; `Makefile` drives dev/CI tasks and resolves Xcode's bundled `swift-format` for the strict repository style gate.
