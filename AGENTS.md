...
- **Action execution**: `Sources/TapTickKit/Services/ShortcutExecutor.swift` — app hide/focus/launch via activation-capable running instances with Launch Services fallback, plus inline script and script-file execution.
